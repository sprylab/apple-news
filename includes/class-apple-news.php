	...
	public function migrate_header_settings() {
		...
		$wp_settings = $this->clone_settings(
			$wp_settings, array(
				...
				'header7_color'       => 'header_color',
				'header8_color'       => 'header_color',
				...
				'header7_font'        => 'header_font',
				'header8_font'        => 'header_font',
				...
				'header7_line_height' => 'header_line_height',
				'header8_line_height' => 'header_line_height',
			)
		);
