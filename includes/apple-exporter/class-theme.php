...
class Theme {
	...
	private static function initialize_options() {
		self::$_options = array(
			...
			'recirc_header_transform'               => array(
				'default' => 'uppercase',
				'label'   => __( 'Header transformation', 'apple-news' ),
				'options' => array( 'none', 'uppercase' ),
				'type'    => 'select',
			),
			'recirc_header_weight'               => array(
				'default' => 'bold',
				'label'   => __( 'Header font weight', 'apple-news' ),
				'options' => array( 'regular', 'bold' ),
				'type'    => 'select',
			),
		...
		self::$_groups = array(
			...
			'recirc_header'         => array(
				...
				'settings' => array(
					...
					'recirc_header_color',
					'recirc_header_weight',
					'recirc_header_transform',
					'recirc_link_font',
					'recirc_link_size',
