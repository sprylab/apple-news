...
class Theme {
	...
	private static function initialize_options() {
		self::$_options = array(
			...
			'header1_margin'                  => array(
				'default'     => 0,
				'label'       => __( 'Header 1 Margin', 'apple-news' ),
				'type'        => 'integer',
			),
			'header2_color'                     => array(
				'default' => '#333333',
			...
			'header2_margin'                  => array(
				'default'     => 0,
				'label'       => __( 'Header 2 Margin', 'apple-news' ),
				'type'        => 'integer',
			),
			'header3_color'                     => array(
				'default' => '#333333',
			...
			'header3_margin'                  => array(
				'default'     => 0,
				'label'       => __( 'Header 3 Margin', 'apple-news' ),
				'type'        => 'integer',
			),
			'header4_color'                     => array(
				'default' => '#333333',
			...
			'header4_margin'                  => array(
				'default'     => 0,
				'label'       => __( 'Header 4 Margin', 'apple-news' ),
				'type'        => 'integer',
			),
			'header5_color'                     => array(
				'default' => '#333333',
			...
			'header5_margin'                  => array(
				'default'     => 0,
				'label'       => __( 'Header 5 Margin', 'apple-news' ),
				'type'        => 'integer',
			),
			'header6_color'                     => array(
				'default' => '#333333',
			...
			'header6_margin'                  => array(
				'default'     => 0,
				'label'       => __( 'Header 6 Margin', 'apple-news' ),
				'type'        => 'integer',
			),
