...
class Apple_News_Test extends WP_UnitTestCase {
	...
	public function testMigrateHeaderSettings() {
		...
		unset( $legacy_settings['header7_color'] );
		unset( $legacy_settings['header8_color'] );
		...
		unset( $legacy_settings['header7_font'] );
		unset( $legacy_settings['header8_font'] );
		...
		unset( $legacy_settings['header7_line_height'] );
		unset( $legacy_settings['header8_line_height'] );
		$apple_news = new Apple_News();
		update_option( $apple_news::$option_name, $legacy_settings );
		...
		$expected_settings['header7_color'] = '#abcdef';
		$expected_settings['header8_color'] = '#abcdef';
		...
		$expected_settings['header7_font'] = 'TestFont';
		$expected_settings['header8_font'] = 'TestFont';
		...
		$expected_settings['header7_line_height'] = 100;
		$expected_settings['header8_line_height'] = 100;
